...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('seller_activity_logs', function (Blueprint $table) {
            ...
            $table->string('action_type'); // listing_created, listing_updated, order_received, review_received, message_sent, etc.
            $table->string('action_description');
            $table->morphs('related'); // related model (listing, order, review, etc.)
