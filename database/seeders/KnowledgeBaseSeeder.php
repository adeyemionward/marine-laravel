...
class KnowledgeBaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin = User::where('email', 'admin@marine.africa')->first();
        if (!$admin) {
            $admin = User::create([
                'name' => 'System Admin',
        ...
        $categories = [
            [
                ...
                'icon' => '🚀',
                'color' => '#10B981',
                'description' => 'Everything you need to know to get started with Marine.africa',
                'sort_order' => 1,
            ],
            [
            ...
            [
                ...
                'icon' => '🏪',
                'color' => '#F59E0B',
                'description' => 'Complete guide for sellers on Marine.africa',
                'sort_order' => 4,
            ],
            [
                'name' => 'FAQs',
        ...
        $documentsData = [
            'Getting Started' => [
                ...
                [
                    ...
                    'summary' => 'Step-by-step guide to creating your Marine.africa account',
                    'content' => "# Creating Your Marine.africa Account\n\nFollow these simple steps to join the Marine.africa community:\n\n## Step 1: Registration\n\n1. Visit the Marine.africa registration page\n2. Enter your email address\n3. Choose a strong password\n4. Provide your full name\n5. Click 'Create Account'\n\n## Step 2: Email Verification\n\n1. Check your email inbox\n2. Click the verification link\n3. Your account is now active\n\n## Step 3: Complete Your Profile\n\n1. Add your phone number\n2. Set your location\n3. Upload a profile picture\n4. Add a brief bio\n\n## Next Steps\n\n- Explore equipment categories\n- Set up your seller profile (optional)\n- Start browsing listings",
